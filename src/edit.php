        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <p class="h5">Update Student<a href="home.php" class="btn btn-md btn-danger float-end">Back</a></p>
                </div>
                ...
                <form class="" action="function.php" method="post">
                    ...
                    <input type="submit" class="btn btn-primary mt-2" name="update_student" value="Update">
                </form>
